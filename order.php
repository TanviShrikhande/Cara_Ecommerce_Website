<?php
    ...
    //inserting orders
    $insert_orders="Insert into `user_orders` (usersId, amount_due, invoice_number, total_products, order_date, order_status) values ($user_id, $subtotal, $invoice_number, $count_products, NOW(), '$status')";
    ...
    //orders pending
    $insert_pending_orders="Insert into `orders_pending` (usersId, invoice_number, product_id, quantity, order_status) values ($user_id, $invoice_number, $product_id, $quantity , '$status')";
